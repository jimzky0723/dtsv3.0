<form action="<?php echo e(asset('/form/office-order')); ?>" method="POST" id="form_route">
    ...
    <div class="modal-body">
        ...
        <table class="table table-hover table-form table-striped">
            <tr>
                ...
                <td class="col-sm-8"><input type="text" name="prepared_date" class="form-control" value="<?php echo e($user); ?>" required readonly></td>
            </tr>
            <tr>
