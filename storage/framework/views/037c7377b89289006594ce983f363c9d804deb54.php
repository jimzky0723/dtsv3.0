    ...
    <div class="alert alert-jim" id="inputText">
        ...
        <form class="form-inline form-accept" method="POST">
            ...
            <div class="form-group">
                <input type="text" class="form-control" value="<?php echo e(Session::get("search")); ?>" placeholder="Quick Search" id="search" autofocus>
                <button type="button" class="btn btn-default" onclick="searchSection($(this));" data-link="<?php echo e(asset('searchSection')); ?>"><i class="fa fa-search"></i> Search</button>
                <div class="btn-group">
