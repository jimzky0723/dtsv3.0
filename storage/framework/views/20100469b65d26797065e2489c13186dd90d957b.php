...
<form action="<?php echo e(asset('/form/justification/letter')); ?>" method="POST">
    ...
    <div class="modal-body">
        <table class="table table-hover table-form table-striped">
            <tr>
                ...
                <td class="col-sm-8"><input type="text" name="prepared_by" class="form-control" value="<?php echo e($name); ?>" readonly></td>
            </tr>
            <tr>
