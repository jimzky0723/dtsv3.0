    ...
    <div class="table-responsive">
        ...
        <table class="table table-list table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="#track" data-link="<?php echo e(asset('document/track/'.$doc->route_no)); ?>" data-toggle="modal" class="btn btn-sm btn-success col-sm-12"><i class="fa fa-line-chart"></i> Track</a></td>
                    <td><a class="title-info" data-route="<?php echo e($doc->route_no); ?>" data-link="<?php echo e(asset('/document/info/'.$doc->route_no.'/'.Auth::user()->id.'/'.$doc->doc_type)); ?>" href="#document_info" data-toggle="modal"><?php echo e($doc->route_no); ?></a></td>
                    ...
                    <td>
                        <?php if($doc->doc_type == 'PRR_S' || $doc->doc_type == 'PRR_M'): ?>
