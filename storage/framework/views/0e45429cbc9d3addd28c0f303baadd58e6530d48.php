...
<form action="" method="POST" id="create" data-link="<?php echo e(asset('check/user')); ?>">
            ...
            <tr>
                ...
                <td class="col-sm-8">
                    <select name="designation" required id="select_dis" class="chosen-select form-control" data-link="<?php echo e(asset('/get/section')); ?>">
                        ...
                        <?php foreach($dis as $a): ?>
                            <option value="<?php echo e($a->id); ?>"><?php echo e($a->description); ?></option>
                        <?php endforeach; ?>
                    </select>
                </td>
            </tr>
