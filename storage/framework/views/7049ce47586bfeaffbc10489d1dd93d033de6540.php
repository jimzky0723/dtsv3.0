        ...
        <div class="new-times-roman">
            ...
            <table class="table1" cellpadding="0" cellspacing="0">
                ...
                <?php foreach($meal as $row): ?>
                    <tr>
                        <td id="border-bottom" class="align-top"><?php echo e($item_no); ?></td>
                        <td id="border-bottom" class="align-top"><?php echo e($row->qty); ?></td>
                        <td id="border-bottom" class="align-top"><?php echo e($row->issue); ?></td>
                        ...
                        <td id="border-bottom" class="align-top">
                            <strong><span style="font-family: DejaVu Sans;">&#x20b1; </span> <?php echo e(number_format($row->unit_cost,2)); ?></strong>
                        </td>
                        <td id="border-bottom" class="align-top">
                            <strong style="color: mediumvioletred;"><span style="font-family: DejaVu Sans;">&#x20b1; </span> <?php echo e(number_format($row->estimated_cost,2)); ?></strong>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
                <tr>
                    ...
                    <td id="border-top"></td>
                    <td id="border-top"></td>
                    <td id="border-top" width="35%"><br><br> Prepared By:<br><br><u><?php echo e($user->fname.' '.$user->mname.' '.$user->lname); ?></u><br><?php echo e(\App\Designation::find(Auth::user()->designation)->description); ?></th>
                    <td id="border-top"></td>
                    <td id="border-top"></td>
                    <td id="border-top"></td>
                </tr>
            ...
            <table class="letter-head" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td id="border-top" colspan="7" class="align"><u><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(Users::find($tracking->requested_by)->fname.' '.Users::find($tracking->requested_by)->mname.' '.Users::find($tracking->requested_by)->lname); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></u><br><?php echo e(\App\Designation::find(Users::find($tracking->requested_by)->designation)->description); ?></td>
                </tr>
                <tr>
