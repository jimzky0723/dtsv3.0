            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo e(asset('document/accept')); ?>"><i class="fa fa-plus"></i>&nbsp;&nbsp; Accept Document</a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo e(asset('document')); ?>"><i class="fa fa-file"></i>&nbsp;&nbsp; Created Document</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo e(URL::to('document/logs')); ?>"><i class="fa fa-file-archive-o"></i>&nbsp;&nbsp; Print Logs</a></li>
                        <li><a href="<?php echo e(URL::to('document/section/logs')); ?>"><i class="fa fa-file-archive-o"></i>&nbsp;&nbsp; Print Section Logs</a></li>
                        <?php if(Auth::user()->user_priv==1): ?>
                        <li class="divider"></li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user"></i>
                        Account
                        <?php if($count_report): ?>
                        <span class="badge" style="background:#eb9316;"><?php echo e($count_report); ?></span>
                        <?php endif; ?>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <?php if($count_report): ?>
                            <li style="background:#eb9316;"><a href="<?php echo e(url('reported')); ?>"><i class="fa fa-warning"></i>&nbsp;&nbsp; Section Reported</a></li>
                        <?php endif; ?>
