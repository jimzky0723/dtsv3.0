...
<form action="<?php echo e(asset('/form/application/leave')); ?>" method="POST" id="form_route">
    ...
    <div class="modal-body">
        <table class="table table-hover table-form table-striped">
            <tr>
                ...
                <td class="col-sm-8"><input type="text" name="routed_from" class="form-control" value="<?php echo e($user); ?>" required readonly></td>
            </tr>
            <tr>
                <td class="col-sm-3"><label>Prepared date</label></td>
                <td class="col-sm-1">:</td>
                <td class="col-sm-8"><input type="text" name="prepared_date" class="form-control" required readonly value="<?php echo e(date('Y-m-d H:i:s')); ?>"></td>
            </tr>
            <tr>
