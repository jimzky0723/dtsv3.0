                    ...
                    <tr>
                        ...
                        <td class="text-<?php echo $class?>">
                            ...
                            <?php if($out->received_by==0): ?>
                                ...
                                ?>
                                <br />
                                    <button data-toggle="modal" data-target="#releaseTo" data-route_no="<?php echo e($out->route_no); ?>" onclick="changeRoute($(this), '<?php echo $out->id ?>')" type="button" class="btn btn-info btn-xs"><i class="fa fa-send"></i> Change</button>
