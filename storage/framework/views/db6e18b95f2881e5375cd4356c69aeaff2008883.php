                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select  class="chosen-select-static form-control" onchange="get_designation($(this),'section')" name="requested_by" required>
                                    <option value="<?php echo e(Users::find(Section::find(Auth::user()->section)->head)->id); ?>"><?php echo e(Users::find(Section::find(Auth::user()->section)->head)->fname.' '.Users::find(Section::find(Auth::user()->section)->head)->mname.' '.Users::find(Section::find(Auth::user()->section)->head)->lname); ?></option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-10">
                            <select class="chosen-select-static form-control" onchange="get_designation($(this),'division');" name="division_head" required>
                                <option value="<?php echo e(Users::find(Division::find(Auth::user()->division)->head)->id); ?>"><?php echo e(Users::find(Division::find(Auth::user()->division)->head)->fname.' '.Users::find(Division::find(Auth::user()->division)->head)->mname.' '.Users::find(Division::find(Auth::user()->division)->head)->lname); ?></option>
