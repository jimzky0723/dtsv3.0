    ...
    <div class="col-lg wrapper">
        <div class="alert alert-jim">
            ...
            <form method="post" id="form" action="<?php echo e(asset('prr_supply_update')); ?>">
                ...
                <input type="hidden" value="<?php echo e($user->id); ?>" name="prepared_by">
                    ...
                    <div class="content-wrapper">
                        ...
                        <section class="invoice">
                            <div class="table-responsive">
                                ...
                                <table class="letter-head" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2"><?php echo e(Division::find($user->division)->description); ?></td>
                                        <td colspan="2">PR No:</td>
                                        <td>Date:<input class="form-control datepickercalendar" name="prepared_date" value="<?php echo e(substr($tracking->prepared_date,5,2).'/'.substr($tracking->prepared_date,8,2).'/'.substr($tracking->prepared_date,0,4)); ?>"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Section:</td>
                                        <td colspan="2"><?php echo e(Section::find($user->section)->description); ?></td>
                                    ...
                                    <tr id="<?php echo e($count); ?>">
                                        ...
                                        <td id="border-bottom" class="<?php echo e('description'.$count); ?> align-top" width="40%">
                                            ...
                                            <textarea class="textarea" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="specification[]" id="<?php echo e('specification'.$count); ?>" onkeyup="trapping()"><?php echo e($row->specification); ?></textarea><small id="<?php echo e('E_specification'.$count); ?>">required!</small>
                                        </td>
                                    ...
                                    <!-- <tr>
                                        ...
                                        <td id="border-top"></td>
                                        <td id="border-top"></td>
                                        <td id="border-top"><br><br> Prepared By:<br><br><u><?php echo e($user->fname.' '.$user->mname.' '.$user->lname); ?></u><br><?php echo e(Designation::find($user->designation)->description); ?></td>
                                        <td id="border-top"></td>
                                        <td id="border-top"></td>
                                        <td id="border-top"></td>
                                    </tr> -->
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            ?>
                                            <input id="section_head" class="form-control" value="<?php echo e($requested_by); ?>" readonly>
                                        </div>
                                    </div>
                                    <hr>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="section_head" class="form-control" value="<?php echo e($requested_designation); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="purpose" name="purpose"><?php echo e($tracking->purpose); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="charge_to"><?php echo e($tracking->source_fund); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" style="padding: 2%">
                                ...
                                <?php if($routed < 2 || Auth::user()->user_priv): ?>
                                <div class="btn-group btn-group-md pull-right">
