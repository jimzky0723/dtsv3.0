    ...
    <div class="alert alert-jim" id="inputText">
        ...
        <form class="form-inline form-accept">
            <div class="form-group">
                <input type="text" class="form-control" id="search" value="<?php echo e(Session::get('search')); ?>" placeholder="Quick Search" autofocus>
                <button type="button" class="btn btn-default" onclick="searchDivision($(this));" data-link="<?php echo e(asset('searchDivision')); ?>"><i class="fa fa-search"></i> Search</button>
                <div class="btn-group">
