<form action="<?php echo e(asset('/form/justification/letter')); ?>" method="POST" id="form_route"
    ...
    <div class="modal-body">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <label class="col-md-6" style="font-weight: bolder;font-size: medium;color: #985f0d;"><?php echo e($user); ?></label>
            </div>
            <div class="row">
