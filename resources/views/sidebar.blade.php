        ...
        <div class="panel-body"> 
            ...
            <table class="table table-hover table-{{ $pend->id }}">
                ...
                <tbody>
                    ...
                    <tr><td>
                            <a href="#document_info" data-route="{{ $pend->route_no }}" data-link="{{ asset('document/'.$pend->route_no) }}" data-toggle="modal" class="btn btn-success btn-xs"><i class="fa fa-bookmark"></i> Details</a>
