    ...
    <div class="modal-body">
        <table class="table table-hover table-form table-striped">
            <tr>
                ...
                <td class="col-sm-8"><input type="text" name="firstname" class="form-control" required></td>
            </tr>
            <tr>
                <td class="col-sm-3"><label>Middle name</label></td>
                <td class="col-sm-1">:</td>
                <td class="col-sm-8"><input type="text" name="middlename" class="form-control" required></td>
            </tr> <tr>
                <td class="col-sm-3"><label>Last name</label></td>
                <td class="col-sm-1">:</td>
                <td class="col-sm-8"><input type="text" name="lastname" class="form-control" required></td>
            </tr>
            <tr>
