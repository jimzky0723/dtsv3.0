    ...
    <body>
        <div class="new-times-roman">
            ...
            <table class="letter-head" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td id="border-top" colspan="7" class="align"><u><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ Users::find($tracking->requested_by)->fname.' '.Users::find($tracking->requested_by)->mname.' '.Users::find($tracking->requested_by)->lname }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></u><br>{{ \App\Designation::find(Users::find($tracking->requested_by)->designation)->description }}</td>
                </tr>
                <tr>
