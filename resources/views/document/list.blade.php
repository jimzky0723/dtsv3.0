                ...
                <ul class="dropdown-menu">
                    <li class="dropdown-submenu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="#document_form" data-toggle="modal" data-link="{{ asset('form/bills') }}">Bills, Cash Advance Replenishment, Grants/Fund Transfer</a></li>
                    ...
                    <li><a href="#document_form" data-toggle="modal" data-link="{{ asset('general') }}">General Document</a> </li>
                </ul>
            </div>
        </div>
    </form>
