<tr id="{{ $_GET['count'] }}">
    ...
    <td id="border-bottom" class="{{ 'qty'.$_GET['count'] }}"><input type="text" name="qty[]" id="{{ 'qty'.$_GET['count'] }}" class="form-control" onkeyup="trapping()" required><small id="{{ 'E_qty'.$_GET['count'] }}">required!</small></td>
    ...
    <td id="border-bottom" class="{{ 'unit_cost'.$_GET['count'] }}"><input type="text" name="unit_cost[]" id="{{ 'unit_cost'.$_GET['count'] }}" class="form-control" onkeyup="trapping()" required><small id="{{ 'E_unit_cost'.$_GET['count'] }}">required!</small></td>
