<tr id="{{ $_GET['count'] }}">
    ...
    <td id="border-bottom" class="{{ 'qty'.$_GET['count'] }}"><input type="text" name="qty[]" id="{{ 'qty'.$_GET['count'] }}" class="form-control" onkeydown="trapping(event,true)" onkeyup="trapping(event,true)" required><small id="{{ 'E_qty'.$_GET['count'] }}">required!</small></td>
    ...
    <td id="border-bottom" class="{{ 'unit_cost'.$_GET['count'] }}"><input type="text" name="unit_cost[]" id="{{ 'unit_cost'.$_GET['count'] }}" class="form-control" onkeydown="trapping(event,true)" onkeyup="trapping(event,true)" required><small id="{{ 'E_unit_cost'.$_GET['count'] }}">required!</small></td>

    <td id="border-bottom" class="{{ 'estimated_cost'.$_GET['count'] }}">
        <input type="hidden" name="estimated_cost[]" id="{{ 'estimated_cost'.$_GET['count'] }}" class="form-control">
        <strong style="color:green;">&#x20b1;</strong><strong style="color:green" id="{{ 'e_cost'.$_GET['count'] }}"></strong>
    </td>
</tr>
